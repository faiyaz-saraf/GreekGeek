    ...
    <form onSubmit={handleSubmit} className="w-full max-w-[720px] mx-auto">
      <div className="relative">
        ...
        <button
          ...
          className="btn-search absolute right-2 top-1/2 -translate-y-1/2 bg-gradient-to-r from-amber-400 to-amber-400 hover:from-amber-400 hover:to-amber-400 disabled:bg-gray-700 disabled:from-gray-700 disabled:to-gray-700 disabled:text-gray-500 text-white px-5 py-2.5 rounded-lg text-sm font-semibold"
        >
          {loading ? (
            <svg
